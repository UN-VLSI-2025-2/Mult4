...
**Caso 1**: A=5 (0101), B=3 (0011) → PP=15 (00001111)
- Ciclo 1: B[0]=1, ACC = 0 + 5 = 5
- Ciclo 2: B[0]=1, ACC = 5 + 10 = 15
- Ciclo 3: B=0, multiplicación completa

**Caso 2**: A=7 (0111), B=6 (0110) → PP=42 (00101010)
- Ciclo 1: B[0]=0, ACC = 0
- Ciclo 2: B[0]=1, ACC = 0 + 14 = 14
- Ciclo 3: B[0]=1, ACC = 14 + 28 = 42
- Ciclo 4: B=0, operación finalizada
